    ...
    <div class="row">
        <div class="col-lg-12">
            ...
            <!--begin::Form-->
                ...
                {{ BsForm::post(route('admins.store'),['id'=>'add-admin-form','class'=>'validate-form kt-form','enctype'=>'multipart/form-data']) }}
                    <div class="kt-portlet__body">
                        <div class="kt-section kt-section--first">
                            <div class="row">
                                <div class="col-6">
                                    {{ BsForm::text('name')->attribute('class','form-control validate[required]')->label(__("Name")) }}
                                </div>
                                <div class="col-6">
                                    {{ BsForm::email('email')->attribute('class','form-control validate[required]')->label(__("Email")) }}
                                </div>
                                <div class="col-6">
